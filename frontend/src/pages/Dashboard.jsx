...
const fields = [
  ...
  { name: 'West Barley', type: 'barley', status: 'verified', reading: 'Temp: 22C' },
  { name: 'Greenhouse A', type: 'greenhouse', status: 'warning', reading: 'Moisture: 38%' },
  { name: 'Greenhouse B', type: 'greenhouse', status: 'verified', reading: 'Temp: 26C' },
];
  ...
  return (
    <div className="px-6 lg:px-8 py-6 pb-24 lg:pb-6 bg-cream min-h-screen">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <KPICard icon={Droplets} value="47" label="Readings Today" detail="up +12 vs yesterday">
